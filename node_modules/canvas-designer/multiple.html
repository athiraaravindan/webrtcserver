...
<head>
	...
	<meta name="description" content="Multiple HTML5 Canvas Designer ® Muaz Khan – A tool aimed to give you a full-fledged drawing surface and also auto generate appropriate code for you in different formats! Generator/Tool/Editor – 2D API/Context">
...
#btn-undo, #btn-close-undo-popup, #btn-close-dataURL-popup, #btn-getDataURL {
    font-size: 1.2em;
    padding: 2px 9px;
}

#btn-close-undo-popup, #btn-close-dataURL-popup {
    padding: 0 6px;
    border-radius: 50%;
    padding-bottom: 1px;
    color: red;
...
<div id="widget-container-1" style="position: fixed;bottom: 0;right: 20%;left: 20%;height: 50%;top:0;border: 1px solid black; border-top:0; border-bottom: 0;"></div>

<div id="widget-container-2" style="position: fixed;bottom: 0;right: 20%;left: 20%;height: 50%;top: 50%;border: 1px solid black; border-top:1px solid black; border-bottom: 0;"></div>
